  ...
  return (
    <div className="terms-container">
      ...
      <p>
        ...
        <a href="/privacy-policy">Privacy Policy</a>, all applicable laws and
      ...
      <p>
        ...
        materials (information or software) on DEV Community's web site for
      ...
      <p>
        ...
        these restrictions and may be terminated by DEV Community at any time.
      ...
      <h2>3. Disclaimer</h2>
      <p>
        a. The materials on DEV Community's web site are provided "as is". DEV
        ...
        or other violation of rights. Further, DEV Community does not warrant or
      ...
      <h2>4. Limitations</h2>
      <p>
        In no event shall DEV Community or its suppliers be liable for any
        damages (including, without limitation, damages for loss of data or
        profit, or due to business interruption,) arising out of the use or
        inability to use the materials on DEV Community's Internet site, even if
        DEV Community or a DEV Community authorized representative has been
      ...
      <p>
        The materials appearing on DEV Community's web site could include
        technical, typographical, or photographic errors. DEV Community does not
        warrant that any of the materials on its web site are accurate,
        complete, or current. DEV Community may make changes to the materials
        contained on its web site at any time without notice. DEV Community does
        not, however, make any commitment to update the materials.
      </p>

      <h2>6. Links</h2>
      <p>
        DEV Community has not reviewed all of the sites linked to its Internet
        web site and is not responsible for the contents of any such linked
        site. The inclusion of any link does not imply endorsement by DEV
        Community of the site. Use of any such linked web site is at the user's
        own risk.
      </p>
      ...
      <p>
        ...
        they post on DEV Community — including, but not limited to, information
        ...
        yo@dev.to. DEV Community may remove any content users post for any
        reason.
      </p>

      <h2>8. Site Terms of Use Modifications</h2>
      <p>
        DEV Community may revise these terms of use for its web site at any time
      ...
      <h2>9. DEV Community Trademarks and Logos Policy</h2>
      <p>
        All uses of the DEV Community logo, DEV Community badges, brand slogans,
        iconography, and the like, may only be used with express permission from
        DEV Community. DEV Community reserves all rights, even if certain assets
        are included in DEV Community open source projects. Please contact
        yo@dev.to with any questions or to request permission.
      </p>

      <h2>10. Reserved Names</h2>
      <p>
        DEV Community has the right to maintain a list of reserved names which
        will not be made publicly available. These reserved names may be set
        aside for purposes of proactive trademark protection, avoiding user
        confusion, security measures, or any other reason (or no reason).
      </p>
      <p>
        Additionally, DEV Community reserves the right to change any
        already-claimed name at its sole discretion. In such cases, DEV
        Community will make reasonable effort to find a suitable alternative and
        assist with any transition-related concerns.
      </p>

      <h2>11. Content Policy</h2>
      <p>
        The following policy applies to comments, articles, and all other works
        shared on the DEV Community platform:
      </p>
      <ul>
        <li>
          Users must make a good-faith effort to share content that is on-topic,
          of high-quality, and is in the correct community.
        </li>
        <li>
      ...
      <p>
        DEV Community reserves the right to remove any content that it deems to
        be in violation of this policy at its sole discretion. DEV Community
        reserves the right to restrict any user’s ability to participate on the
        platform at its sole discretion.
      </p>

      <h2>12. Governing Law</h2>
      <p>
        Any claim relating to DEV Community's web site shall be governed by the
